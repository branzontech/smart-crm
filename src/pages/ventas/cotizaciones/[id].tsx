      ...
      <div className="max-w-5xl mx-auto cotizacion-container">
        ...
        <div id="cotizacion-preview" className="bg-white shadow-md rounded-lg overflow-hidden print:shadow-none cotizacion-printable">
          ...
          <div className="p-6 space-y-8 print:p-3 print:space-y-3">
            ...
            <div>
              <h3 className="text-lg font-semibold mb-3 text-[#2d1e2f] print:mb-1">Términos y Condiciones</h3>
              <div className="text-sm text-gray-600 space-y-2 print:space-y-0 print:text-xs">
              ...
              <div className="mt-10 pt-10 border-t text-center print:mt-3 print:pt-3">
                <div className="inline-block">
                  ...
                  <div className="w-48 border-t border-black mt-2 pt-1 mx-auto print:w-32 print:mt-1 print:pt-0.5">
                    ...
                    <p className="text-sm text-gray-600 print:text-xs">{cotizacion.empresaEmisor.nombre}</p>
                  </div>
                </div>
              </div>
            )}
          ...
          <div className="bg-gray-50 p-6 text-center text-gray-600 text-sm print:bg-white print:p-2 print:text-xs">
